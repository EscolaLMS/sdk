...
var EscolaLMSContextProvider = function (_a) {
    ...
    var _e = (0, useLocalStorage_1.useLocalStorage)("lms", "course", defaultConfig.course), course = _e[0], setCourse = _e[1];
    var _f = (0, useLocalStorage_1.useLocalStorage)("lms", "settings", defaultConfig.settings), settings = _f[0], setSettings = _f[1];
    var _g = (0, useLocalStorage_1.useLocalStorage)("lms", "tags", defaultConfig.uniqueTags), uniqueTags = _g[0], setUniqueTags = _g[1];
    var _h = (0, useLocalStorage_1.useLocalStorage)("lms", "categories", defaultConfig.categoryTree), categoryTree = _h[0], setCategoryTree = _h[1];
    var _j = (0, useLocalStorage_1.useLocalStorage)("lms", "tags", defaultConfig.program), program = _j[0], setProgram = _j[1];
    var _k = (0, useLocalStorage_1.useLocalStorage)("lms", "cart", defaultConfig.cart), cart = _k[0], setCart = _k[1];
    var _l = (0, useLocalStorage_1.useLocalStorage)("lms", "token", null), token = _l[0], setToken = _l[1];
    var _m = (0, useLocalStorage_1.useLocalStorage)("lms", "user", defaultConfig.user), user = _m[0], setUser = _m[1];
    var _o = (0, react_1.useState)(defaultConfig.progress), progress = _o[0], setProgress = _o[1];
    var _p = (0, useLocalStorage_1.useLocalStorage)("lms", "tutors", defaultConfig.tutors), tutors = _p[0], setTutors = _p[1];
    var _q = (0, useLocalStorage_1.useLocalStorage)("lms", "orders", defaultConfig.orders), orders = _q[0], setOrders = _q[1];
    var _r = (0, useLocalStorage_1.useLocalStorage)("lms", "payments", defaultConfig.payments), payments = _r[0], setPayments = _r[1];
    var _s = (0, react_1.useState)(defaultConfig.tutor), tutor = _s[0], setTutor = _s[1];
    var _t = (0, useLocalStorage_1.useLocalStorage)("lms", "pages", defaultConfig.pages), pages = _t[0], setPages = _t[1];
    var _u = (0, useLocalStorage_1.useLocalStorage)("lms", "page", defaultConfig.page), page = _u[0], setPage = _u[1];
    var _v = (0, useLocalStorage_1.useLocalStorage)("lms", "fontSize", defaultConfig.fontSize), fontSize = _v[0], setFontSize = _v[1];
