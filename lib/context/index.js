...
var defaultConfig = {
    ...
    setIsDisabledNextTopicButton: function (state) { return false; },
};
...
var sortProgram = function (lessons) {
    return __spreadArray([], lessons, true).sort(function (lessonA, lessonB) { return typeof lessonA.order === 'number' && typeof lessonB.order === 'number' ? lessonA.order - lessonB.order : 0; })
        .map(function (lesson) { return (__assign(__assign({}, lesson), { topics: __spreadArray([], (lesson.topics || []), true).sort(function (topicA, topicB) { return typeof topicA.order === 'number' && typeof topicB.order === 'number' ? topicA.order - topicB.order : 0; }) })); });
};
...
var EscolaLMSContextProvider = function (_a) {
    ...
    var _r = (0, useLocalStorage_1.useLocalStorage)("lms", "fontSize", defaultConfig.fontSize), fontSize = _r[0], setFontSize = _r[1];
    // TODO. remove from here 
    var _s = (0, useLocalStorage_1.useLocalStorage)("lms", "isDisabledNextTopicButton", defaultConfig.isDisabledNextTopicButton), isDisabledNextTopicButton = _s[0], setIsDisabledNextTopicButton = _s[1];
    ...
    var fetchCourses = (0, react_1.useCallback)(function (filter) {
        ...
        return (0, courses_1.course)(filter).then(function (response) {
            if (response.success) {
                setCourses({
                    loading: false,
                    list: response.data,
    ...
    var fetchProgram = (0, react_1.useCallback)(function (id) {
        ...
        return token ? (0, courses_1.getCourseProgram)(id, token)
    ...
    var removeFromCart = (0, react_1.useCallback)(function (courseId) {
        ...
        return (0, cart_1.removeFromCart)(courseId, token)
            .then(function (response) {
            setCart(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, value: __assign(__assign({}, prevState.value), { items: prevState && prevState.value ? prevState.value.items.filter(function (item) { return item.id !== courseId; }) : [] }) })); });
            fetchCart();
        })
            .catch(function (error) {
            setCart(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, error: error.data })); });
    ...
    var payWithStripe = (0, react_1.useCallback)(function (paymentMethodId) {
        return token ? (0, cart_1.payWithStripe)(paymentMethodId, token).then(function (res) {
            console.log(res);
        }) : Promise.reject();
    }, [token]);
    var fetchProgress = (0, react_1.useCallback)(function () {
        ...
        return token ? (0, courses_1.progress)(token).then(function (res) {
            setProgress({
                loading: false,
                value: res,
            });
    ...
    var fetchOrders = (0, react_1.useCallback)(function () {
        ...
        return token ? (0, cart_1.orders)(token)
            .then(function (res) {
    ...
    var fetchPayments = (0, react_1.useCallback)(function () {
        ...
        return token ? (0, cart_1.payments)(token)
            .then(function (res) {
            if (res.success) {
                setPayments({
                    loading: false,
    ...
    var sendProgress = (0, react_1.useCallback)(function (courseId, data) {
        return token ? (0, courses_1.sendProgress)(courseId, data, token).then(function (res) {
            setProgress(function (prevState) { return (__assign(__assign({}, prevState), { value: prevState && prevState.value ? prevState.value.map(function (courseProgress) {
    ...
    var h5pProgress = (0, react_1.useCallback)(function (courseId, topicId, statement) {
        ...
        return token ? (0, courses_1.h5pProgress)(topicId, statementId, statement, token) : null;
    }, [token]);
    var updateProfile = (0, react_1.useCallback)(function (body) {
        setUser(function (prevState) { return (__assign(__assign({}, prevState), { loading: true })); });
        return token ? (0, auth_1.updateProfile)(body, token).then(function (res) {
            if (res.success === true) {
    ...
    var updateAvatar = (0, react_1.useCallback)(function (file) {
        ...
        return token ? (0, auth_1.updateAvatar)(file, token).then(function (res) {
            if (res.success === true) {
    ...
    var topicPing = (0, react_1.useCallback)(function (topicId) {
        return token ? (0, courses_1.topicPing)(topicId, token).catch(function (err) { return err; }) : Promise.reject();
    }, [token]);
    ...
    return ((0, jsx_runtime_1.jsx)(exports.EscolaLMSContext.Provider, __assign({ value: {
            ...
            isDisabledNextTopicButton: isDisabledNextTopicButton,
