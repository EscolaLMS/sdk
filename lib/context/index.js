...
var user_groups_1 = require("./../services/user_groups");
...
var defaultConfig = {
    ...
    fetchUserGroup: function () { return Promise.reject(); },
    userGroups: {
        loading: false,
    },
    fetchUserGroups: function () { return Promise.reject(); },
    registerableGroups: {
        loading: false,
    },
    fetchRegisterableGroups: function () { return Promise.reject(); },
    course: {
        loading: false,
    },
...
var EscolaLMSContextProvider = function (_a) {
    ...
    var _c = (0, useLocalStorage_1.useLocalStorage)("lms", "userGroup", defaultConfig.userGroup), userGroup = _c[0], setUserGroup = _c[1];
    var _d = (0, useLocalStorage_1.useLocalStorage)("lms", "userGroups", defaultConfig.userGroups), userGroups = _d[0], setUserGroups = _d[1];
    var _e = (0, useLocalStorage_1.useLocalStorage)("lms", "registerableGroups", defaultConfig.registerableGroups), registerableGroups = _e[0], setRegisterableGroups = _e[1];
    var _f = (0, useLocalStorage_1.useLocalStorage)("lms", "course", defaultConfig.course), course = _f[0], setCourse = _f[1];
    var _g = (0, useLocalStorage_1.useLocalStorage)("lms", "settings", defaultConfig.settings), settings = _g[0], setSettings = _g[1];
    var _h = (0, useLocalStorage_1.useLocalStorage)("lms", "tags", defaultConfig.uniqueTags), uniqueTags = _h[0], setUniqueTags = _h[1];
    var _j = (0, useLocalStorage_1.useLocalStorage)("lms", "categories", defaultConfig.categoryTree), categoryTree = _j[0], setCategoryTree = _j[1];
    var _k = (0, useLocalStorage_1.useLocalStorage)("lms", "tags", defaultConfig.program), program = _k[0], setProgram = _k[1];
    var _l = (0, useLocalStorage_1.useLocalStorage)("lms", "cart", defaultConfig.cart), cart = _l[0], setCart = _l[1];
    var _m = (0, useLocalStorage_1.useLocalStorage)("lms", "token", null), token = _m[0], setToken = _m[1];
    var _o = (0, useLocalStorage_1.useLocalStorage)("lms", "user", defaultConfig.user), user = _o[0], setUser = _o[1];
    var _p = (0, react_1.useState)(defaultConfig.progress), progress = _p[0], setProgress = _p[1];
    var _q = (0, useLocalStorage_1.useLocalStorage)("lms", "tutors", defaultConfig.tutors), tutors = _q[0], setTutors = _q[1];
    var _r = (0, useLocalStorage_1.useLocalStorage)("lms", "orders", defaultConfig.orders), orders = _r[0], setOrders = _r[1];
    var _s = (0, useLocalStorage_1.useLocalStorage)("lms", "payments", defaultConfig.payments), payments = _s[0], setPayments = _s[1];
    var _t = (0, react_1.useState)(defaultConfig.tutor), tutor = _t[0], setTutor = _t[1];
    var _u = (0, useLocalStorage_1.useLocalStorage)("lms", "pages", defaultConfig.pages), pages = _u[0], setPages = _u[1];
    var _v = (0, useLocalStorage_1.useLocalStorage)("lms", "page", defaultConfig.page), page = _v[0], setPage = _v[1];
    var _w = (0, useLocalStorage_1.useLocalStorage)("lms", "fontSize", defaultConfig.fontSize), fontSize = _w[0], setFontSize = _w[1];
    ...
    var fetchUserGroup = (0, react_1.useCallback)(function (id) {
        setUserGroup(function (prevState) { return (__assign(__assign({}, prevState), { loading: true })); });
        return (0, user_groups_1.userGroup)(id)
            .then(function (response) {
            if (response.success) {
                setUserGroup({
                    loading: false,
            ...
            if (response.success === false) {
                setUserGroup(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, error: response })); });
            }
        })
            .catch(function (error) {
            setUserGroup(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, error: error })); });
        });
    }, [userGroups]);
    var fetchRegisterableGroups = function () {
        setRegisterableGroups(function (prevState) { return (__assign(__assign({}, prevState), { loading: true })); });
        return (0, user_groups_1.registerableGroups)()
            .then(function (response) {
            if (response.success) {
            ...
            if (response.success === false) {
                setRegisterableGroups(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, error: response })); });
            }
        })
            .catch(function (error) {
            setRegisterableGroups(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, error: error })); });
        });
    };
    var fetchUserGroups = (0, react_1.useCallback)(function (_a) {
        var pageSize = _a.pageSize, current = _a.current;
        setUserGroups(function (prevState) { return (__assign(__assign({}, prevState), { loading: true })); });
        return (0, user_groups_1.userGroups)({ pageSize: pageSize, current: current })
            .then(function (response) {
            if (response.success) {
                setUserGroups({
                    loading: false,
            ...
            if (response.success === false) {
                setUserGroups(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, error: response })); });
            }
        })
            .catch(function (error) {
            setUserGroups(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, error: error })); });
        });
    }, [userGroups]);
    ...
    return ((0, jsx_runtime_1.jsx)(exports.EscolaLMSContext.Provider, __assign({ value: {
            ...
            registerableGroups: registerableGroups,
            fetchRegisterableGroups: fetchRegisterableGroups,
